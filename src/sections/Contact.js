    ...
    return (
        <div className="w-full bg-no-repeat" style={{
            ...
            <div className=" p-10  py-15  flex  flex-col">
                <div className=" mb-5  p-2  text-6xl font-black text-white  antialiased  text-center">OPEN FOR SPRING 2021 INTERNSHIPS</div>
                <a className="m-auto  w-1/5" href="mailto:ishadalangin@gmail.com">
                    <button
