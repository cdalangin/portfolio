...
export default function Footer() {
    return (
        <footer className="footer bg-pink-200 bg-opacity-60 relative pt-2 mt-12">
                    ...
                    <div className="mt-8 sm:mt-0 sm:w-full sm:px-6 flex justify-center">
                        <div className="flex flex-col mr-5">
                            <a href="https://www.linkedin.com/in/cfdalangin/">
                                <button
                                    className="p-6 text-center text-white transition border-2 border-transparent bg-purple-300 rounded-full ripple hover:bg-pink-200 hover:border-purple-300 focus:outline-none"
                                >
                                    <ImLinkedin
                                        className="h-8 w-8"
                                    />
